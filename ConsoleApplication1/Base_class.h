...
public:
	...
	Base_class(Base_class* p_head_object, string s_object_name = "Default_name");//конструктор
	...
	Base_class* find_object_tree(string object_name);//поиск оъекта по имени в системе
