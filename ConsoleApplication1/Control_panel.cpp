...
#include "Elevator.h"
#include "Floor.h"
Control_panel::Control_panel(Base_class* p_head_object, string
	s_object_name)
	: Base_class(p_head_object, s_object_name) {}void Control_panel::Handler_from_passenger(string& destination_floor) {
